...
<script type = "text/javascript">
    ...
    if (leadingZeros_<?php echo $moduleTitle; ?> === "date" || leadingZeros_<?php echo $moduleTitle; ?> === "both") {
        monthStr = month < 10 ? "0" + month : String(month);
        dateStr = date < 10 ? "0" + date : String(date);
    } else {
    ...
    if (date_<?php echo $moduleTitle; ?> !== "no") {
        ...
        // Remove leading zeros from date if needed (for "none")
        if (leadingZeros_<?php echo $moduleTitle; ?> === "none") {
