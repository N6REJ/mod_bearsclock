...
<?php  if($params->get('layout')=="vert"){ ?>
	<div id = "JowClock-vert">
	<!-- Timezone Before -->
	<?php  if($params->get('show-timezone')=="yes" && $params->get('timezone-position')=="before" ){ ?>
		
			<div id = "JowClockTimezone_<?php  echo $moduleTitle; ?>" class="JowClockTimezone<?php  echo $moduleSuffix; ?>" >
	...
	<?php  if($params->get('date')!="no"){ ?>
			...
			<div id = "JowClockDate_<?php  echo $moduleTitle; ?>" class="JowClockDate<?php  echo $moduleSuffix; ?>" >
			</div>
		
	<?php  } ?>	
	<!-- Time -->
		
			<div id= "JowClockTime_<?php  echo $moduleTitle; ?>" class="JowClockTime<?php  echo $moduleSuffix; ?>" >
			</div>
	...
	<div id = "JowClock-horz_<?php  echo $moduleTitle; ?>">		
		<!-- Timezone Before -->
	<?php  if($params->get('show-timezone')=="yes" && $params->get('timezone-position')=="before" ){ ?>
			<span id = "JowClockTimezone_<?php  echo $moduleTitle; ?>" class="JowClockTimezone<?php  echo $moduleSuffix; ?>" >
				<?php  echo $outTimezone . " "; ?>
			</span>
	<?php  } ?>
	<!-- Date -->
	<?php  if($params->get('date')!="no"){ ?>
			<span id = "JowClockDate_<?php  echo $moduleTitle; ?>" class="JowClockDate<?php  echo $moduleSuffix; ?>" >
			</span>
	<?php  } ?>	
	<!-- Time -->
			<span id= "JowClockTime_<?php  echo $moduleTitle; ?>" class="JowClockTime<?php  echo $moduleSuffix; ?>" >
			</span>			
...
<script type="text/javascript" >	
	...
	function JowClockUpdate_<?php  echo $moduleTitle; ?>()
	{
		...
		if(date_<?php  echo $moduleTitle; ?>!="no"){
			...
			if(month=="01"){ textMonth="January";}
			if(month=="02"){ textMonth="February";}
			if(month=="03"){ textMonth="March";}
			if(month=="04"){ textMonth="April";}
			if(month=="05"){ textMonth="May";}
			if(month=="06"){ textMonth="June";}
			if(month=="07"){ textMonth="July";}
			if(month=="08"){ textMonth="August";}
			if(month=="09"){ textMonth="September";}
			if(month=="10"){ textMonth="October";}
			if(month=="11"){ textMonth="November";}
			if(month=="12"){ textMonth="December";}
			}
